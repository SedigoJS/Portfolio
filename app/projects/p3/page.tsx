...
const sampleProject: ProjectData = {
  title: "Randomizer / Raffle Wheel",
  description: "A fun, interactive tool that allows users to randomly select options or winners, similar to the Google Wheel, for raffles or decision-making.",
  images: [
    { src: "/p3-1.png", alt: "Smart home dashboard" },
    { src: "/p3-2.png", alt: "Energy consumption graph" },
    { src: "/p3-3.png", alt: "Smart device network" },
    { src: "/p3-4.png", alt: "Mobile app interface" },
    { src: "/p3-5.png", alt: "Mobile app interface" },
  ]
}
